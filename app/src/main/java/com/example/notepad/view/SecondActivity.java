...
import static com.example.notepad.R.layout.activity_second;
...
import com.example.notepad.viewmodel.Adapter;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = new DatabaseHelper(this); // выделение памяти и задание тпекущего контекста работы с БД



        // вывод данных на экран черпез адаптер
        recyclerView.setLayoutManager(new LinearLayoutManager(this)); // задание структуры вывода данных в recyclerView
        adapter = new Adapter(this,SecondActivity.this,notesList); // инициализация адаптера и передача в него данных из БД
